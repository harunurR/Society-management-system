			...
			<div class="col-md-12">
				<div class="card-box">
					...
					<div class="form-row">
						...
						<div class="form-group col-md-4">
							<label for="per_add" class="col-form-label">Pay Amount</label>
							<input type="text" class="form-control" id="inputPassword4" placeholder="Pay Amount" name="amount" value="<?= set_value('amount', '') ?>">
							<?= form_error('amount') ?>
						</div>
					</div>
					<div class="form-group">
